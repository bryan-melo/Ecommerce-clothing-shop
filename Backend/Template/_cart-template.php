...
<section id="cart" class="py-3">
    <div class="container-fluid w-75">
        <h5 class="font-baloo font-size-20">Shopping Cart</h5> <!-- shopping cart items -->
        <div class="row">
            <div class="col-sm-9">
                <!-- cart items-->
                <div class="row border-top py-3 mt-3">
                    <div class="col-sm-2">
                        <a href="product.html"><img src="/assets/Products/men/image1.png" style="height: 120px;"
                                alt="cart1" class="img-fluid"></a>
                    </div>
                    <div class="col-sm-8">
                        <h5 class="font-baloo font-size-20">Men's Leather Jacket</h5>
                ...
                <div class="row border-top py-3 mt-3">
                    <div class="col-sm-2">
                        <a href="product.html"><img src="/assets/Products/men/image2.png" style="height: 120px;"
                                alt="cart1" class="img-fluid"></a>
                    </div>
                    <div class="col-sm-8">
                        <h5 class="font-baloo font-size-20">Mens Jogger Pants | White</h5>
                        <small>by Gucci</small>
                        <!-- product rating -->
                        <div class="d-flex">
                            <div class="rating text-warning font-size-12">
                        ...
                        <div class="qty d-flex pt-2">
                            <div class="d-flex font-rale w-25">
                                <button class="qty-up border bg-light" data-id="pro2"><i
                                        class="fas fa-angle-up"></i></button>
                                <input type="text" data-id="pro2" class="qty_input border px-2 w-100 bg-light" disabled
                                    value="1" placeholder="1">
