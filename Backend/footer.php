    ...
    <div class="container justify-content-center me-5">
        <div class="row">
            <div class="col-lg-3 col-12" style="padding-right: 50px;">
                ...
                <p class="font-size-14 font-rale text-white-50">Discover the latest in fashion for men, women, and kids
                    at
                    FashionThreads
...
<div class="copyright text-center bg-dark text-white py-2">
    <p class="font-rale font-size-14">&copy; Copyrights 2023. Desiged By <a href="#"
            class="color-second">FashionThreads</a></p>
</div>
<!-- !end #footer -->
